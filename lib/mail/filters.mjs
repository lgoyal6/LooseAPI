...
const EVENT_STRONG_TERMS =
  '{subject:"you\'re invited" subject:"you are invited" subject:"registration is confirmed" ' +
  'subject:"registration confirmed" subject:"registration approved" subject:rsvp ' +
  'subject:"is happening soon" subject:"appointment booked" subject:invitation}';
...
export const FILTERS = [
  {
    label: "Jobs/Active",
    query: `${ACTIVE_TERMS} -category:promotions -${TRANSACTIONAL_TERMS}`,
  },
  {
    label: "Jobs/Closed",
    query: `{${CLOSED_SENDERS} ${CLOSED_TERMS}} -${ACTIVE_TERMS} -${EVENT_STRONG_TERMS} -category:promotions -${TRANSACTIONAL_TERMS}`,
  },
  {
    label: "Events",
    query: `{${EVENT_SENDERS} ${EVENT_TERMS}} -${ACTIVE_TERMS} -category:promotions -${TRANSACTIONAL_TERMS}`,
  },
  {
    label: "Orders",
